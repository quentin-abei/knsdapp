...
contract Domains is ERC721URIStorage {
 ...
 error InvalidName(string name);
  ...
  mapping(string => string) public records;
    ...
    constructor(string memory _tld) payable ERC721("Kucoin Community Chain Name Service", "KNS") {
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Kcc name service", "image": "data:image/svg+xml;base64,',
...
function withdraw() public onlyOwner {
	...
	require(success, "Failed to withdraw KCS");
} 
}